...
export default function ResetPasswordConfirmPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        const errorMsg = data.errors ? Object.values(data.errors).flat().join(' ') : 'Failed to reset password.';
  ...
  return (
    <div className="min-h-screen flex font-sans bg-[#fcf9f2]">
      ...
      <div 
        ...
        style={{ backgroundImage: `url('https://images.unsplash.com/photo-1508847154043-be12a62861c1?q=80&w=1000')` }}
      >
        {/* Darkening Overlay */}
        ...
        <div className="relative z-20 text-white max-w-lg space-y-4 mt-auto">
          <h2 className="text-4xl lg:text-5xl font-extrabold tracking-tight leading-tight">
            Nurturing your daily table.
          </h2>
          <p className="text-white/80 text-sm lg:text-base font-medium leading-relaxed">
            Access the freshest local produce delivered directly from our farms to your doorstep.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-between p-6 sm:p-12 lg:p-16">
        ...
        <div className="mx-auto w-full max-w-sm my-auto space-y-6">
          <div className="space-y-2">
            {!success ? (
              <>
                <h1 className="text-3xl md:text-4xl font-extrabold text-[#144227] tracking-tight">Create a new password</h1>
              ...
              <div className="space-y-2">
                ...
                <h1 className="text-2xl font-extrabold text-[#144227] tracking-tight">Password Reset Successful!</h1>
                <p className="text-xs text-[#717971] leading-relaxed">
                  Your password has been changed. Redirecting you to the login page now...
                </p>
              </div>
            )}
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="space-y-1.5 pt-1">
                  ...
                  <div className="flex justify-between items-center text-[10px] text-[#717971] font-bold">
                    <span>Password strength</span>
                    {password && <span className="text-[#144227]">{strengthText[strength]}</span>}
                  </div>
                </div>
              </div>
          ...
          <div className="flex justify-center pt-2">
            <Link 
              href="/login" 
              className="flex items-center gap-1.5 text-xs font-bold text-[#144227] hover:underline"
            >
