                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex flex-col">
                        ...
                        {s.agreed_price && (
                          <span className="inline-block text-[9px] font-extrabold text-emerald-800 bg-emerald-100 px-2 py-0.5 rounded uppercase mt-0.5 w-fit">
                            {formatCurrency(s.agreed_price)}/{s.unit} negotiated
                          </span>
                        )}
                      </div>
                    </td>
