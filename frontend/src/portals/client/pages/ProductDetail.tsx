      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 bg-white rounded-3xl p-6 sm:p-8 border border-[#e5e2db] shadow-sm">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3 pt-3 border-t border-[#f0eee7]">
            ...
            >
              <Handshake size={16} /> 
              {activeThread?.status === 'accepted' ? 'View Finalized Price Negotiation' : 'Propose Price Negotiation'}
            </button>
          </div>
          ...
          <div className="bg-[#f0eee7]/60 border border-[#e5e2db] rounded-xl p-4 mt-6 space-y-2">
            <p className="text-xs text-[#414942] leading-relaxed">
              <span className="font-bold text-[#144227]">Quality Guarantee:</span> Sourced from verified local producers. {product.status !== 'accepted' && 'Price negotiations are subject to order quantities and supplier confirmation.'}
            </p>
